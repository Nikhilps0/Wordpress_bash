...
mysql -u root -p'55zK4THjpdHzcMdU' -e "create database wordpress;"
mysql -u root -p'55zK4THjpdHzcMdU' -e "create user 'wordpress'@'localhost' identified by '55zK4THjpdHzcMdU';"
mysql -u root -p'55zK4THjpdHzcMdU' -e "grant all privileges on wordpress.* to 'wordpress'@'localhost';"
...
sed -i 's/password_here/55zK4THjpdHzcMdU/g' /var/www/html/wp-config-sample.php
